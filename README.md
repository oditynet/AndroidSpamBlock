...
Ver 0.2: - Добавил получение обновления паттернов с интернета
         - Добавил вкладки для настроек и паттернов
         
Ver 0.1: НАучился блокировать звонки
...
TODO: 1) Входящий звонок на 0,5 сек вы все же услышите. Надо Исправить
